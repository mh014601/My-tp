        ...
        <ul>
            <li>
                <div class="shop-info">
                    ...
                    <div class="shop-info-img"><a href="#"><img src="/Public/Home1/images/s1.jpg"></a></div>
            ...
            <div class="shop-info">
                <input type="checkbox" class="check goods-check goodsCheck">
                <div class="shop-info-img"><a href="#"><img src="/Public/Home1/images/s2.jpg"></a></div>
                <div class="shop-info-text">
                    <h4>2017夏季新款韩版蕾丝拼接荷叶袖露肩雪纺娃娃衫上衣女短袖雪...</h4>
                    <div class="shop-brief"><span>重量:3.3kg</span><span>颜色:标配版</span></div>
                    <div class="shop-price">
            ...
            <li>
                <div class="shop-info">
                    <input type="checkbox" class="check goods-check goodsCheck">
                    <div class="shop-info-img"><a href="#"><img src="/Public/Home1/images/s3.jpg"></a></div>
                    <div class="shop-info-text">
                        <h4>2017夏季新款韩版蕾丝拼接荷叶袖露肩雪纺娃娃衫上衣女短袖雪...</h4>
                        <div class="shop-brief"><span>重量:3.3kg</span><span>颜色:标配版</span></div>
                        <div class="shop-price">
...
<div class="payment-bar">
    ...
    <div class="shop-total">
        <strong>总价：<i class="total" id="AllTotal">100.00</i></strong>
        <span>减免：123.00</span>
    </div>
