...
<div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="<?php echo U('Goods/goodsAddAction');?>" method="post" enctype="multipart/form-data">
                <ul class="forminfo">
                    <li>
                    ...
                    <li>
                        ...
                        <div class="vocation">
                            <select class="select1" name="cate_id" id="changeCate">
                                ...
                                <?php if(is_array($cateList)): foreach($cateList as $key=>$fo): ?><option value="<?php echo ($fo['id']); ?>"> |--<?php echo str_repeat("--",substr_count($fo['path'],','));?>
